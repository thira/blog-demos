...
<head>
	...
	<title>Simple Spring Bean validation example</title>
...
<body>
		...
		<form:form id="form" method="post" modelAttribute="simpleFormBean">
			<div id="formContent">
				...
				<fieldset>
			  	...
			  	<p><button id="submitWithoutValidation" type="submit">Submit (without validation)</button></p>
			  </div>
		</form:form>
	</div>
	...
	<script type="text/javascript">
			$(document).ready(function() {
				$("#submitWithoutValidation").click(function() {
					var form = $("#form");
					$.post(form.attr("action") + "/ignoreValidationRules", form.serialize(), function(html) {
						var content = $(html).find('#formContent');
			
						$("#formContent").replaceWith(content.html());
					});
					return false;  
				});			
			});
